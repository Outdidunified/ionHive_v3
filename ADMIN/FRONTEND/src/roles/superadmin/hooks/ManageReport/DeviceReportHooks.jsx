...
const useDeviceReport = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
        ...
        // Check for status and message in the response, not just HTTP status
        if (responseData?.status === "Failed") {
            showWarningAlert("No Data", responseData?.message || "No data found for the selected date range.");
            return; // Exit early if there's a custom failure message
        }
        ...
        // Handle Axios error response correctly
