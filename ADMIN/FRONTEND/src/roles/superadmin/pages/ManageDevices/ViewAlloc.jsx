...
import { useViewAllocated } from '../../hooks/ManageDevice/ViewAllocHooks';

const ViewAllocated = ({ userInfo, handleLogout }) => {
    const navigate = useNavigate();
    const { newDevice } = useViewAllocated();
    ...
    const handleEditDeviceList = (newUser) => {
        navigate('/superadmin/EditAllocatedDevice', { state: { newUser } });
    };
                            ...
                            <div className="col-md-12 grid-margin">
                                <div className="row">
                                    <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                                        <h3 className="font-weight-bold">View Charger Details</h3>
                                    </div>
                                    <div className="col-12 col-xl-4">
                                        <div className="justify-content-end d-flex">
                                            <button type="button" className="btn btn-outline-primary btn-icon-text" onClick={() => handleEditDeviceList(newDevice)} style={{ marginRight: '10px' }}>
                                            ...
                                            <div className="col-md-12 grid-margin">
                                                <div className="row">
                                                    ...
                                                    <div className="row col-12 col-xl-12 viewDataCss">
                                                        ...
                                                        <div className="col-md-4">
                                                            <div className="form-group row">
                                                                <div className="col-sm-12" style={{ fontWeight: 'bold' }}>Assigned Reseller: <span style={{ fontWeight: 'normal' }}>{newDevice.reseller_email_id ? newDevice.reseller_email_id : '-'}</span></div>
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group row">
                                                                <div className="col-sm-12" style={{ fontWeight: 'bold' }}>Assigned Client: <span style={{ fontWeight: 'normal' }}>{newDevice.client_email_id ? newDevice.client_email_id : '-'}</span></div>
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group row">
                                                                <div className="col-sm-12" style={{ fontWeight: 'bold' }}>Assigned Association: <span style={{ fontWeight: 'normal' }}>{newDevice.association_email_id ? newDevice.association_email_id : '-'}</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
