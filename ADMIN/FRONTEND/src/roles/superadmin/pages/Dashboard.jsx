                        ...
                        <div className="row d-flex justify-content-center">
                            ...
                            <div className="col-md-6 d-flex flex-wrap justify-content-center">
                                {[
                                    ...
                                    { title: 'Resellers', count: totalCounts.resellersCount, color: '#FF9800', icon: 'fa-users', bgColor: '#FF9800' },
                                    ...
                                    { title: 'App Users', count: totalCounts.appUsersCount, color: '#9C27B0', icon: 'fa-mobile-alt', bgColor: '#9C27B0' }
                                ].map((item, index) => (
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 mb-3" ref={totalChargersRef}>
                                            <div className="card p-3 shadow-sm" style={{
                                                ...
                                                <h5 className="font-weight-normal mb-3 text-center" style={{
                                                    color: '#007BFF', textTransform: 'uppercase', fontSize: '18px', letterSpacing: '1px'
                                                }}>
                                                    Total Chargers
                                                </h5>
                                                <div style={{
                                                    flexGrow: 1, overflow: 'auto', maxHeight: '270px',
                                                    border: `1px solid #007BFF66`, borderRadius: '8px'
                                                }}>
                                                    <div style={{ overflowX: 'auto' }}>
                                                        <table className="table table-bordered table-hover" style={{ tableLayout: 'fixed', width: '100%' }}>
                                                            <thead>
                                                                <tr style={{
                                                                    textAlign: 'center', borderBottom: `2px solid #007BFF`,
                                        ...
                                        <div className="col-md-6 mb-3" ref={onlineChargersRef}>
                                            <div className="card p-3 shadow-sm" style={{
                                                ...
                                                <h5 className="font-weight-normal mb-3 text-center" style={{
                                                    color: '#4CAF50', textTransform: 'uppercase', fontSize: '18px', letterSpacing: '1px'
                                                }}>
                                                    Online Chargers
                                                </h5>
                                                <div style={{
                                                    flexGrow: 1, overflow: 'auto', maxHeight: '270px',
                                                    border: `1px solid #4CAF5066`, borderRadius: '8px'
                                                }}>
                                                    <div style={{ overflowX: 'auto' }}>
                                                        <table className="table table-bordered table-hover" style={{ tableLayout: 'fixed', width: '100%' }}>
                                                            <thead>
                                                                <tr style={{
                                                                    textAlign: 'center', borderBottom: `2px solid #4CAF50`,
                                                            ...
                                                            <tbody>
                                                                {chargersData.availableChargers.length > 0 ? (
                                                                    chargersData.availableChargers.map((charger, idx) => {
                                                                        ...
                                                                        let connectorColor = connectorType === 'Socket' ? '#007BFF' : '#4CAF50';
                                                                        return (
                                                                            <tr key={idx}>
                                                                                <td
                                                                                    style={{ textAlign: 'center', cursor: 'pointer' }}
                                                    ...
                                                    <table className="table table-bordered table-hover" style={{ tableLayout: 'fixed', width: '100%' }}>
                                                        ...
                                                        <tbody>
                                                            {(chargersData.offlineChargers.length > 0
                                                                ? chargersData.offlineChargers
                                                                : [{ noData: true }]
                                                            ).map((charger, idx) => {
                                                                if (charger.noData) {
                                                                    return (
                                                                        <tr key="no-data">
                                                                            <td colSpan="3" style={{ textAlign: 'center', color: '#9E9E9E' }}>
                                                                                No chargers found
                                                                            </td>
                                                                        </tr>
                                                                    );
                                                                ...
                                                                const { statusText, statusColor } = getChargerStatus(charger);
                                                                const connectorType = charger.connector_type === 1 ? 'Socket' : 'Gun';
                                                                const connectorColor = connectorType === 'Socket' ? '#007BFF' : '#4CAF50';
                                                                ...
                                                                return (
                                                                    <tr key={idx}>
                                                                        ...
                                                                        <td style={{ textAlign: 'center', color: statusColor }}>{statusText}</td>
                                                                        <td style={{ textAlign: 'center', color: connectorColor }}>{connectorType}</td>
                                                                    </tr>
                                                                );
                                                            })}
                                                        </tbody>
