...
const useClientOccpConfig = (userInfo) => {
    ...
    const getActionPayload = async () => {
        try {
            setLoading(true)
            const response = await axios.get('http://172.232.109.123:4444/OcppConfig/GetAction');
        ...
        try {
            ...
            Swal.fire({
                ...
                didOpen: async () => {
                    ...
                    try {
                        const response = await axios.get(`http://172.232.109.123:4444/OcppConfig/SendOCPPRequest?id=${chargerId}&req=${encodeURIComponent(JSON.stringify(payload))}&actionBtn=${selectedCommand}`);
    ...
    return {
        ...
        customConfigKey,setCustomConfigKey,
        value, setValue,
        ...
        handleSetChargingProfile,
        onSendCommand,
        handleChargerIdChange,handleClearCache,handleRemoteStartTransaction
    }}
    export default useClientOccpConfig;