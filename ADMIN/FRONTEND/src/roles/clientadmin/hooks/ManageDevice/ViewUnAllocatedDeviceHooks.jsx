...
const useViewUnalloc = (userInfo) => {
    ...
    const [newDevice, setNewDevice] = useState({
        ...
        modified_date: '', reseller_commission: '', short_description: '', socket_count: '', vendor: '', wifi_password: '', wifi_username: '',  wifi_module: '', bluetooth_module: '',
    });
